...
class DecklinkConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_decklink'
...
class BluefishConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_bluefish'
...
class SystemAudioConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_systemaudio'
...
class ScreenConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_screen'
...
class NewtekIVGAConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_newtekivga'
...
class FFMPEGSimpleConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_ffmpegsimple'
...
class FFMPEGAdvancedConsumer(models.Model):
    ...
    class Meta:
        db_table = 'ccgengine_consumers_ffmpegadv'
...
class StreamConsumer(models.Model):
    ...
    narrow = models.BooleanField(
        help_text = 'Is aspect ratio in SD mode enabled.',
        default = False
    )
    ...
    videoBitrate = models.PositiveSmallIntegerField(
        help_text = 'Video bitrate in kBytes/s.',
        default = 1024
    )

    audioBitrate = models.PositiveSmallIntegerField(
        help_text = 'Audio bitrate in kBytes/s.',
        default = 128
    )
    ...
    class Meta:
        db_table = 'ccgengine_consumers_stream'
...
class Configuration(models.Model):
    ...
    pathSettings = models.ForeignKey(
        Paths,
    ...
    class Meta:
        db_table = 'ccgengine_configuration'
